 ...
 * Datos PUROS. Modelo desacoplado por competencia. Gramatica: gerund vs infinitive.
 */
...
export const RELATIONSHIPS_B1 = {
  ...
  lessons: [
    // ================= READING =================
    {
      ...
      content: {
        reading:
          "Ana and Sara enjoy spending time together. They have been close friends for ten years. " +
          "Ana loves talking about everything, and Sara always agrees to listen. They rarely argue, " +
          "and when they do, they decide to talk honestly. Sara wants to travel with Ana next year. " +
          "'A good friend keeps supporting you,' says Ana. 'I can't imagine living without her.' They " +
          "trust each other and hope to stay friends forever.",
        keyPhrases: [
          "Fijate en verbos + gerundio (enjoy spending) e infinitivo (agree to listen).",
          "Busca cuanto tiempo son amigas y que quieren hacer.",
        ],
        check: [
          { prompt: "How long have they been friends?", choices: ["Ten years", "Two years", "One month"], answer: 0 },
          { prompt: "What does Ana love?", choices: ["Arguing", "Talking about everything", "Being alone"], answer: 1 },
          { prompt: "What does Sara want to do next year?", choices: ["Travel with Ana", "Move away", "Stop talking"], answer: 0 },
          { prompt: "What do they do when they argue?", choices: ["Stop talking", "Talk honestly", "Get angry"], answer: 1 },
        ],
      },
      activities: [],
    },
    ...
    // ================= VOCABULARY =================
    {
      ...
      glossary: [
        ...
        { term: "to argue", translation: "discutir" },
        { term: "to get on with", translation: "llevarse bien con" },
    ...
    // ================= GRAMMAR =================
    {
      ...
      grammar: {
        ...
        form: "enjoy/love/hate + -ing · want/decide/agree/hope + to + base",
        examples: ["I enjoy talking.", "She wants to travel.", "They decided to stay."],
        mistakes: [
      ...
      activities: [
        ...
        {
          id: "rel-gram-a3", type: "multiple_choice",
